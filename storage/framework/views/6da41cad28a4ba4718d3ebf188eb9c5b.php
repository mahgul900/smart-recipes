...
<div class="container" style="max-width: 680px; padding: 1.5rem 1rem;">
    ...
    <form action="<?php echo e(route('recipes.store')); ?>" method="POST" enctype="multipart/form-data">
        ...
        <div>
            ...
            <textarea name="ingredients" id="ingredients" rows="3" required><?php echo e(old('ingredients')); ?></textarea>
        </div>

        <div>
            <label for="steps" class="block">Steps</label>
            <textarea name="steps" id="steps" rows="4" required><?php echo e(old('steps')); ?></textarea>
        </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Mah Gul\Downloads\smart-recipes-fixed\resources\views/recipes/create.blade.php ENDPATH**/ ?>
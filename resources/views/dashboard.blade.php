        ...
        <div class="col-md-10">
            <div class="card shadow-sm border-0">
                <div class="card-header" style="background-color: #5c3d2e; color: white; border-radius: 12px 12px 0 0;">
                    <h4>🍽️ Welcome, {{ Auth::user()->name }}!</h4>
                </div>
                ...
                <div class="card-body">
                    ...
                    <div class="row text-center">
                        <div class="col-md-4 mb-4">
                            <a href="{{ route('recipes.create') }}" class="btn btn-accent w-100 rounded-[600] py-3">
                                📝 Submit a Recipe
                            </a>
                        </div>
                        <div class="col-md-4 mb-4">
                            <a href="{{ route('recipes.list') }}" class="btn btn-outline-accent w-100 rounded-[600] py-3">
                                📖 View All Recipes
                            </a>
                        </div>
                        <div class="col-md-4 mb-4">
                            <a href="{{ route('profile.edit') }}" class="btn btn-outline-secondary w-100 rounded-[600] py-3">
                                👤 Edit Profile
                            </a>
                        </div>
                    </div>
                ...
                <div class="container my-8">
                    <div class="alternative-search">
                        ...
                        <form action="{{ route('alternatives.search') }}" method="GET" class="row g-2 justify-content-center">
                    ...
                    <ul class="list-group">
                    <a href="{{ route('recipes.my') }}" class="list-group-item list-group-item-action">
                      ⭐ Recipes you’ve submitted
                </a>
                 <a href="{{ route('alternatives.myreviews') }}" class="list-group-item list-group-item-action">
                    🧂 Ingredient alternatives you’ve reviewed
                </a>
                 <a href="{{ route('reviews.my') }}" class="list-group-item list-group-item-action">
                    ...
                    <div class="mt-4 text-end">
                        <a href="{{ url('/') }}" class="btn btn-outline-secondary rounded-[60px]">⬅ Back to Homepage</a>
                    </div>
                </div>
            </div>
        </div>
